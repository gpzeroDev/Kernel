...
#elif defined(CONFIG_CPU_FREQ_DEFAULT_GOV_INTERACTIVEOSR)
extern struct cpufreq_governor cpufreq_gov_interactiveOSR;
#define CPUFREQ_DEFAULT_GOVERNOR    (&cpufreq_gov_interactiveOSR)
